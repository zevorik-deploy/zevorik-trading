...
export async function POST() {
  try {
    ...
    // Create stock data — 50 INTERNATIONAL / GLOBAL stocks (prices in IDR equivalent)
    const stockData = [
      // ===== Technology Giants =====
      ...
      { code: 'COPPER', name: 'Copper', price: 685000, change: 15200, changePercent: 2.27, open: 669800, high: 692000, low: 665000, volume: 135000000, marketCap: 0, category: 'commodity', sector: 'Commodity', description: 'Industrial metal. Key economic indicator and essential for electrification.', peRatio: 0, pbv: 0, dividendYield: 0, lotSize: 1 },
    ]
